...
function App() {
    ...
    const onDeleteTodo = (key) => {
        setIsTodo(isTodo.filter(item => item.key !== key))
        console.log(isTodo);
    }
    const addTodo = () => {
